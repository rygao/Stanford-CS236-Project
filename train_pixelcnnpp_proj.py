...
parser.add_argument("--train", type=int, default=1, help="0 = eval, 1 = train, 2 = sample, 3 = continue training")
...
parser.add_argument("--start_epoch", type=int, default=0, help="first epoch number")
...
#                              dataloader=val_loader, device=device)
                sample(model, embedder, batches_done, val_loader, device)
...
if __name__ == "__main__":
    ...
    #  Training
    # ----------
    if opt.train in {0, 2, 3}: # LOAD EXISTING MODEL
